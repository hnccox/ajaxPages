...
e107::css(url, '/e107_plugins/ajaxDBQuery/default/css/ajaxMaps.css');
e107::css(url, '/e107_plugins/ajaxDBQuery/default/css/ajaxTables.css');
e107::css(url, '/e107_plugins/ajaxDBQuery/default/css/ajaxTemplates.css');
...
require_once(e_PLUGIN."/ajaxDBQuery/default/ajaxMap.php");
require_once(e_PLUGIN."/ajaxDBQuery/default/ajaxTable.php");
require_once(e_PLUGIN."/ajaxDBQuery/default/ajaxTemplate.php");
	...
	<div class="col-md-4">
        <div class="square">
            <div class="leaflet map content"
                ...
                data-lng="5.45"
                data-zoom="7"
                data-url="//wikiwfs.geo.uu.nl/e107_plugins/ajaxDBQuery/default/ajaxDBQuery.php"
                data-db="llg"
...
$sqlParams = [];
$sqlParams['url'] = "//wikiwfs.geo.uu.nl/e107_plugins/ajaxDBQuery/default/ajaxDBQuery.php";
$sqlParams['db'] = "llg";
