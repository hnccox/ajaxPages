						...
						layerParams: {
							...
							query: {
								0: {
									"select": {
										"columns": {
											0: "llg_it_geom.borehole,llg_it_geom.longitude,llg_it_geom.latitude,llg_it_geom.xy,llg_it_geom.geom,llg_it_boreholeheader.name,llg_it_boreholeheader.drilldate,llg_it_boreholeheader.xco,llg_it_boreholeheader.yco,llg_it_boreholeheader.coordzone,llg_it_boreholeheader.elevation,llg_it_boreholeheader.drilldepth,llg_it_boreholeheader.geom,llg_it_boreholeheader.geol,llg_it_boreholeheader.soil,llg_it_boreholeheader.veget,llg_it_boreholeheader.groundwaterstep,llg_it_boreholeheader.extraremarks,llg_it_boreholeheader.active"
										},
										"from": {
											"table": "llg_it_geom"
										}
